...
LoadModule php5_module C:/Dev/PHP564/php5apache2_2.dll
...
<?php
	...
	echo "<title>AMP TEST</title><center><hr><h2>Apache Works !!!</h2><hr>" ;

	$mysql_conn = mysqli_connect( "localhost", "root", "enter" ) ;

	if( $mysql_conn ) {
		echo "<h2>MySQL Successfully Connected !!!</h2><hr> " ;
	} else {
		echo "<h2>MySQL Connection Failed !!!</h2><hr> " ;
	}

	echo "<h2>PHP Enabled !!!</h2><hr></center>" ;
